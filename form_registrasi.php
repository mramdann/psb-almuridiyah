...
if (isset($_POST['daftar'])) {
    ...
    $query = $koneksi->query("INSERT INTO tbl_peserta (nama, jenis_kelamin, nik, no_kk, tempat_lahir, tgl_lahir, no_hp, agama, alamat, foto, jenis_pendaftaran, asal_sekolah, jalur_pendaftaran, status, nama_ayah, pendidikan_ayah, pekerjaan_ayah, thn_lahir_ayah, nama_ibu, pendidikan_ibu, pekerjaan_ibu, thn_lahir_ibu, id_thnajaran) 
                                VALUES ('$nama','$kelamin','$nik','$kk','$tempat_lahir','$tgl_lahir','$hp','$agama','$alamat','$nama_gambar','$jenis_pendaftaran','$asal_sekolah','$jalur_pendaftaran','$status','$nama_ayah',' $pendidikan_ayah',' $pekerjaan_ayah','$thn_lahir_ayah','$nama_ibu',' $pendidikan_ibu',' $pekerjaan_ibu','$thn_lahir_ibu','$ajaran')");
